...
('date_format',            'F j, Y',                      'string',  'general',  'PHP date format for display'),
('time_format',            'h:i A',                       'string',  'general',  'PHP time format for display'),
('session_timeout',        '480',                         'integer', 'security', 'Session timeout in minutes (480 = 8h)'),
('max_failed_attempts',    '5',                           'integer', 'security', 'Max failed login attempts before lockout'),
