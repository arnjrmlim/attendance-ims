...
<form class="panel p-3 mb-3 row g-2 no-print">
    ...
    <div class="col-md-2"><input class="form-control" type="date" name="start_date" value="<?= e($_GET['start_date'] ?? date('Y-m-01')) ?>"></div>
    <div class="col-md-2"><input class="form-control" type="date" name="end_date" value="<?= e($_GET['end_date'] ?? date('Y-m-d')) ?>"></div>
...
<div class="panel p-4">
    ...
    <div class="table-responsive"><table class="table table-sm align-middle"><thead><tr><th>Date</th><th>Employee</th><th>Department</th><th>Branch</th><th>Status</th><th>Late</th><th>Undertime</th><th>Hours</th></tr></thead><tbody><?php foreach ($rows as $row): ?><tr><td><?= e($row['attendance_date']) ?></td><td><?= e($row['employee_name']) ?></td><td><?= e($row['department_name']) ?></td><td><?= e($row['branch_name']) ?></td><td><?= e($row['day_status']) ?></td><td><?= e($row['late_minutes']) ?></td><td><?= e($row['undertime_minutes']) ?></td><td><?= e($row['total_hours']) ?></td></tr><?php endforeach; ?></tbody></table></div>
