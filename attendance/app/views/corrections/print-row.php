...
<head>
    ...
    <title>Attendance Correction - <?= e($request['employee_name'] ?? 'Unknown') ?></title>
    <style>
        @media print {
...
?>
    ...
    <div class="print-section">
        ...
        <div class="print-value">
            <span class="print-label">Attendance Date:</span>
            <?= e($request['attendance_date'] ?? '—') ?>
        </div>
        <div class="print-value">
            <span class="print-label">Correction Type:</span>
            <?= e($request['correction_type'] ?? '—') ?>
        </div>
        <?php if (!empty($request['original_time_in'])): ?>
        <div class="print-value">
            <span class="print-label">Original Time In:</span>
            <?= e($request['original_time_in']) ?>
        </div>
        <?php endif; ?>
        <?php if (!empty($request['original_time_out'])): ?>
        <div class="print-value">
            <span class="print-label">Original Time Out:</span>
            <?= e($request['original_time_out']) ?>
        </div>
        <?php endif; ?>
        <?php if (!empty($request['requested_time_in'])): ?>
        <div class="print-value">
            <span class="print-label">Requested Time In:</span>
            <?= e($request['requested_time_in']) ?>
        </div>
        <?php endif; ?>
        <?php if (!empty($request['requested_time_out'])): ?>
        <div class="print-value">
            <span class="print-label">Requested Time Out:</span>
            <?= e($request['requested_time_out']) ?>
        </div>
        <?php endif; ?>
        <div class="print-value">
